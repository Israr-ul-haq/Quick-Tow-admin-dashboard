...
export default class DriversService {
  getDrivers = async () => {
    try {
      const response = await axios.get(`api/Driver/GetAllDrivers`)
      return response
    } catch (error) {
  ...
  UploadInsurence = async (userId, testInfo, data) => {
    ...
    try {
      ...
      const response = await axios.post(`api/Account/UploadInsuranceInfo/${userId}/${testInfo}`, data, config)
      return response
    } catch (error) {
      return error.response
    }
  ...
  delete = async (driverId) => {
    try {
      const response = await axios.delete(
        `api/Driver/DeleteDriver/${driverId}`,
      )
      return response
    } catch (error) {
      return error.response
