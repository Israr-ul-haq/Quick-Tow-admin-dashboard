              ...
              <div className="col-12 column_margin">
                <div className="dasboardstatscards">
                  <div className="dasboardstatscards_column">
                    <div className="dasboardstatscards_card">
                      <div className="dasboardstatscards_left">
                        ...
                        <h3 className="dasboardstatscards_title">50</h3>
                      </div>
                  ...
                  <div className="dasboardstatscards_column">
                    <div className="dasboardstatscards_card">
                      <div className="dasboardstatscards_left">
                        <h5 className="dasboardstatscards_subtitle">Total Truckers</h5>
                        <h3 className="dasboardstatscards_title">500</h3>
                      </div>
                      <div className="dasboardstatscards_right">
                  ...
                  <div className="dasboardstatscards_column">
                    <div className="dasboardstatscards_card">
                      <div className="dasboardstatscards_left">
                        <h5 className="dasboardstatscards_subtitle">Total Companies</h5>
                        <h3 className="dasboardstatscards_title">20</h3>
                      </div>
                      <div className="dasboardstatscards_right">
                        <img className="dasboardstatscards_image" src="./img/Companies.svg" alt="stat-img" />
                      </div>
                    </div>
                  </div>
                  <div className="dasboardstatscards_column">
                    <div className="dasboardstatscards_card">
                      <div className="dasboardstatscards_left">
                        <h5 className="dasboardstatscards_subtitle">Tow Requests</h5>
                        <h3 className="dasboardstatscards_title">50</h3>
                      </div>
                      <div className="dasboardstatscards_right">
                        <img className="dasboardstatscards_image" src="./img/tow-truck.svg" alt="stat-img" />
                      </div>
=======
