  ...
  const getCompanies = async () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (response.data.code === 1) {
            ...
            const InsurenseResponse = await driverService.UploadInsurence(response.data.data.user.id, testInfo, formData4)
                    ...
                    <form className="myForm" onSubmit={handleSubmit}>
                        <div className="row">
                            <div className="col-12">
                                <div className="headertopbar">
                                    <Link to="/TruckManagement" className="headertopbar_title">
                                        {" "}
                                        ...
                                        <div className="form-group col-md-4">
                                            <div className="password-container position-relative">
                                                ...
                                                <div>
                                                    <select
                                                        onChange={(e) => {
                                                            const c = { ...companydrivers }
                                                            c.CompanyId = e.target.value
                                                            setcompanydrivers(c)
                                                        }} className="form_control">
                                                    ...
                                                    {emptyValidation.companyIdEmpty ? <p style={{ marginTop: "5px", color: "red" }}>Company type is required </p> : ""}
                                                </div>
                                            </div>
                                        </div>
                                        <div className="form-group col-md-4">
                        ...
                        <div className="form-group col-md-12 formbtncontainer__outercontainer--layout3">
                            <div className="formbtncontainer">
                                ...
                                <Link to="/TruckManagement" className="btn_primary btn_email_primary view_user_cancel">
                                    Cancel
                                </Link>
                            </div>
                        </div>
